...
const placeholders = [
  { color: "from-sunny-red to-sunny-orange", icon: "smile" },
  { color: "from-sunny-blue to-sunny-green", icon: "tooth" },
  { color: "from-sunny-yellow to-sunny-orange", icon: "star" },
  { color: "from-sunny-green to-sunny-blue", icon: "heart" },
  { color: "from-sunny-orange to-sunny-red", icon: "sparkle" },
  { color: "from-sunny-blue to-sunny-yellow", icon: "sun" },
  { color: "from-sunny-red to-sunny-yellow", icon: "camera" },
  { color: "from-sunny-green to-sunny-orange", icon: "happy" },
];
...
const icons: Record<string, React.ReactNode> = {
  ...
  tooth: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
      <path d="M12 2C9.5 2 7.5 3.5 7 6C6.5 8.5 6.5 11 7.5 13.5C8.5 16 9.5 18 10.5 20C11 21 11.5 22 12 22C12.5 22 13 21 13.5 20C14.5 18 15.5 16 16.5 13.5C17.5 11 17.5 8.5 17 6C16.5 3.5 14.5 2 12 2Z" />
    </svg>
  ),
  star: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
  ...
  happy: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
      <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866 0-.298-.059-.605-.189-.866-.108-.215-.395-.634-.936-.634zm4.314.634c.108-.215.395-.634.936-.634.54 0 .828.419.936.634.13.26.189.568.189.866 0 .298-.059.605-.189.866-.108.215-.395.634-.936.634-.54 0-.828-.419-.936-.634a1.96 1.96 0 01-.189-.866c0-.298.059-.605.189-.866zm2.023 5.235a.75.75 0 01-1.06 1.06A3.736 3.736 0 0012.018 14c-1 0-1.946.388-2.639 1.098a.75.75 0 01-1.06-1.06A5.236 5.236 0 0112.018 12.5a5.236 5.236 0 013.694 1.619z" clipRule="evenodd" />
    </svg>
  ),
};
    ...
    <SectionWrapper id="instagram" className="py-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <h2 className="font-[family-name:var(--font-nunito)] font-extrabold text-3xl sm:text-4xl text-center text-text-dark mb-4">
          Follow the Fun{" "}
          <span className="text-sunny-red">@sunnykidsdental</span>
        </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {placeholders.map((item, i) => (
            <motion.a
              ...
              className={`aspect-square rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center text-white/80 hover:text-white transition-all relative group overflow-hidden`}
        ...
        <div className="text-center mt-8">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 text-white px-7 py-3 rounded-full font-[family-name:var(--font-nunito)] font-bold hover:shadow-lg transition-all"
          >
